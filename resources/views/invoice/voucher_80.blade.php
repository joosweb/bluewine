...
<div class="ticket centrado">
        <div style="width:330px;">
            ...
            <div class="logo">
            <img src="{{ $photoSrc ?: asset($photo->photo) }}" alt="">
        ...
        <p  style="margin-top:10px; width:330px; ">¡GRACIAS POR SU COMPRA!
            <br>www.osan.cl
            @if(!empty($printMeta['is_reprint']))
            <br><br>COPIA {{ $printMeta['copy_number'] ?? 0 }}
            <br>IMPRESO POR: {{ mb_strtoupper($printMeta['printed_by'] ?? 'N/A') }}
            <br>FECHA: {{ $printMeta['printed_at'] ?? '' }}
            <br>MOTIVO: {{ mb_strtoupper($printMeta['reason'] ?? '') }}
            @endif
            <br>*<br>*<br>
        </p>
