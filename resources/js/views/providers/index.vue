    ...
    <div class="ks-page-header">
        <section class="ks-title-and-subtitle">
            <div class="ks-title-block">
                <h3 class="ks-main-title">App / Proveedores</h3>
                <div class="ks-sub-title">Sección para crear, editar y eliminar proveedores.</div>
            </div>
        </section>
    </div>
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                            ...
                                            <button id="btnUpdate" v-if="editmode" type="submit" class="btn btn-default ks-rounded">GUARDAR</button>
                                            <button id="btnSave" v-if="!editmode" type="submit" class="btn btn-default ks-rounded">GUARDAR</button>
                                          </div>
                                          </form>
                                        </div>
                                      </div>
                                        ...
                                        <div class="card-block" style="padding:15px;">
                                            <div class="row">
                                              ...
                                              <div style="input-group">
                                                 <button class="form-control mb-2 mr-sm-2">{{ this.clientsData.total }} / {{ providersmax }}</button>
                                              </div>
                                                </div>
                                              <div class="col-md-2">
                                                ...
                                                <div class="col-md-3">
                                                    <button class="btn btn-default btn-block" @click="newClient()"><font-awesome-icon :icon="['fas', 'user']" /> NUEVO PROVEEDOR </button>
                                                </div>
                                                <div class="col-md-3">
      ...
      data() {
        ...
        methods: {
          ...
          updateClient: function() {
            ...
            //console.log(form);
            this.form.put('/update/providers/'+this.form.id)
                .then(response => {
                      $("#exampleModal").modal('hide');
                      axios.get('get/providers/id/' + this.form.id)
                      .then(response => {
                        ...
                        $("#run_"+this.form.id).html(response.data[0].run);
                        $("#last_name_"+this.form.id).html(response.data[0].last_name);
                        $("#name_"+this.form.id).html(response.data[0].name);
                        $("#email_"+this.form.id).html(response.data[0].email);
          ...
          searchResult: function() {
            ...
            this.$Progress.start()
            axios.post('get/providers/'+filter+'/' + value)
              .then(response => {
          ...
          createClient: function() {
            ...
            this.form.post('/post/providers')
                .then(response => {
                    if(response.data.success == false){
                      this.$swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        html: 'Ha llegado al maximo de proveedores<br> correspondiente a su plan!',
                      });
          ...
          deleteClient: function(client, index) {
            ...
            this.$swal.fire({
              ...
              if (result.value) {
                axios.delete('/delete/providers/' + client.id)
                .then(response => {
          ...
          getResults(page = 1) {
            this.$Progress.start()
            axios.post('/get/providers?page=' + page)
              .then(response => {
